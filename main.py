...
def summary(objective, content):
    ...
    print('£££££££££')
    print('OUTPUT')
    output[:max_tokens] + "..." if len(output) > max_tokens else output
...
class ScrapeWebsiteTool(BaseTool):
    name: str = "scrape_website"  # Define the name field with type annotation
...
def main():
    ...
    st.sidebar.write("Email: patricksjward@gmail.com")
    st.sidebar.write("GitHub: https://github.com/paward35")
